...
namespace LibraryApplication.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,Name,Year,BorrowerId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,Name,Year,BorrowerId")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
